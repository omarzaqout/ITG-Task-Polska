...
interface SectionBuyProps {
    classNameR?: string;
    classNameQ?: string;
    classNameB?: string;
}

const section_Buy: React.FC<SectionBuyProps> = ({ classNameQ, classNameB, classNameR }) => {
    return (
        <div className={`${classNameR}`}>
            <div className={`  ${classNameQ}`}>
                <div className='max-lg:w-[80px] '>
                ...
                <div className='flex  gap-x-6'>
                    ...
                    <div className="w-[68px] h-10 py-[9px] pr-[27px] pl-[28px] lg:p-[6px_27.5px_4px] text-center relative flex justify-center  bg-[rgba(216,216,216,0.31)]">
            ...
            <div className={`${classNameB}`}>
                <button className='flex w-full h-[64px] bg-[#edb15d] p-[24px_151px] font-[Eina03-Bold] justify-center text-[16px] leading-[24px] mb-4'>
