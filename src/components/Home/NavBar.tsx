...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex flex-col min-w-[375px]  min-h-[106px] w-full bg-black z-20  lg:h-[168px]  lg:p-[12px_107px_24px_109px]
      lg:sticky lg:top-0 lg:shadow-[inset_0_-2px_0_0_#d6ac76] ' >
      {/* Navigation */}
      <nav className="flex  min-w-[375px] w-full  px-4 h-16 pb-2 pt-[3px] shadow-[inset_0_-2px_0_0_#d6ac76] text-white leading-4
      lg:p-0 lg:shadow-[0] lg:h-[84px] font-[Eina03-Regular] tracking-[0.2px] 
      " >

        {/*section1*/}
        {/* Menu */}
        <div className="flex order-1 flex-col items-center justify-center pt-[13px] w-[40px] mr-[25px] text-white
        lg:hidden " onClick={toggleMenu}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className='mb-1' viewBox="0 0 25 25">
          ...
          <span className="h-[12px]  font-normal text-[12px] tracking-[0.2px] text-center">Menu</span>

        </div>
        {/* Artist */}
        <div className="flex flex-col order-2 items-center justify-center   text-[12px] mr-[32px] w-[40px] font-normal tracking-tight pt-[13px] text-white text-center
        lg:pt-5 lg:mr-[23px] lg:w-[86px]
        ">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className='lg:size-8 mb-1' viewBox="0 0 25 25">
          ...
          <span className="h-[12px] lg:h-4"><span className='hidden lg:inline'>Makeup</span> Artists</span>


        </div>
        {/*Call Us*/}
        <div className=" flex flex-col items-center order-4 ml-[31px] mr-[28px] pt-[13px] justify-center lg:order-2
        lg:ml-0 lg:w-[43px] lg:pt-5
        ">
          <svg xmlns="http://www.w3.org/2000/svg" className='lg:size-8 mb-1' width="24" height="24" viewBox="0 0 24 24">
          ...
          <span className="h-[12px] font-normal text-[12px] tracking-[0.2px] text-center lg:h-4 text-white">Call Us</span>
        </div>


        {/* Logo */}
        <div className="flex flex-col justify-center order-3 pt-[13px] mx-auto" onClick={() => { toHome(); }}>
        ...
        {/* Cart */}
        <div className="flex flex-col items-center justify-center order-5  w-[32px] text-xs  tracking-tight text-white  text-center
        lg:mr-[43px]
        ">
          <span className='w-1 h-[13px] mr-[12px] ml-[11px] mb-0 text-[#edb15d] font-[Eina03-Bold]
          lg:size-5 lg:m-0
          
          '>8</span>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className='lg:size-8 mb-1' viewBox="0 0 24 24">
          ...
          <span className="w-full h-3 lg:h-4 ">Cart</span>
        </div>

        {/*Account*/}
        <div className="hidden flex-col items-center justify-center order-5 w-[58px] pt-5  mb-0 ml-0 lg:flex">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" className='mb-1' viewBox="0 0 32 32">
          ...
          <span className="h-[12px] font-[Eina03-Regular] text-[12px] tracking-[0.2px] text-center
          lg:h-4
          text-white">Hi, Maysa</span>
        </div>
      ...
      {/* Search */}
      <div className='flex text-white text-center items-center gap-x-[85px] lg:h-4 lg:mt-10
      '>
        <MenuDesktop />
        <div>
