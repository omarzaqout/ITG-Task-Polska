    ...
    return (
        ...
        <div className='w-full h-16 flex flex-row py-5 px-6 shadow-[inset_0_-2px_0_0_#d6ac76] lg:hidden bg-black'>
            ...
            <div className='flex flex-row h-6 items-center'>
                <span className='font-[Eina03-Regular] text-right text-white leading-4 text-[12px] tracking-[0.2px] w-14.5 m-[2px_4px_2px_4px] '>Hi,Maysa</span>
                <div className='w-6 h-6 p-[1px_3px_3px]'>
